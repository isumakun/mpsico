...
?>
        <style type="text/css" media="print">
            ...
            @media print{
                ...
                body{ background-color:#FFFFFF; background-image:none; color:#000000; font-size: 10px}
                #footer{ display:none;}
                #header{ display:none;}
                #resultados{padding-top: 60px}
                #interpretacion{padding-top: 60px !important;}
                #recomendaciones{
                    padding-top: 20px
                }
            ...
            <style>
                ...
                #interpretacion{padding-top: 160px !important;}
                ...
                <form id="form" method="POST" enctype="multipart/form-data" action="informes/insertarInforme.php">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-xs-12 text-center">
                                        <center><h5 class="uppercase"><b>Datos del Evaluador</h5></center>
                                        <div class="title-line-4 blue less-margin align-center"></div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="inputDefault">Fecha de expedición de la licencia en salud ocupacional*:</label>
