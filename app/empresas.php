                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required=""  name="nit" id="nit" placeholder="Nit de la empresa">
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">Nombre</label>
                                    <input type="text" class="form-control" required=""  name="nombre" id="nombre" placeholder="Nombre de la empresa">
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">Direccion</label>
                                    <input type="text" class="form-control" required=""  name="direccion" id="direccion" placeholder="Dirección de la empresa">
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">Telefono</label>
                                    <input type="text" class="form-control" required=""  name="telefono" id="telefono" placeholder="Telefono de la empresa">
                                </div>    
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required=""  name="email" id="email" placeholder="Email del empresa">
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">Sector</label>
                                    <input type="text" class="form-control" required=""  name="sector" id="sector" placeholder="Sector de la empresa">
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">Ciudad</label>
                                    <input type="search" class="form-control" required=""  name="ciudad" id="ciudad" placeholder="Ciudad de la empresa">
                                </div>

                                <div id="div_logo" class="form-group">
                                    <label class="control-label" for="inputDefault">Logo</label>
                                    <input type="file" class="form-control"  name="imagen" accept=".png, .jpg, .jpeg" id="imagen">
